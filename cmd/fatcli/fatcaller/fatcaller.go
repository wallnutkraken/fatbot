...
func (c *Client) StopTraining() error {
	...
	if err != nil {
		errors.Wrap(err, "StopTraining")
	}
	resp, err := c.client.Do(req)
	if err != nil {
		return errors.Wrap(err, "StopTraining")
	}
...
func (c *Client) StartTraining(request ctrltypes.StartTrainingRequest) error {
	...
	if err != nil {
		return errors.Wrap(err, "StartTraining")
	}
...
func (c *Client) GetStatus() (ctrltypes.StatusResponse, error) {
	...
	if err != nil {
		return ctrltypes.StatusResponse{}, errors.Wrap(err, "GetStatus")
	}
	resp, err := c.client.Do(req)
	if err != nil {
		return ctrltypes.StatusResponse{}, errors.Wrap(err, "GetStatus")
